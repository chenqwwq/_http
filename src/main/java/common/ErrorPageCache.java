...
public class ErrorPageCache {
    ...
    private final HttpHeaders defaultHeader = new HttpHeaders("Content-Type: text/html; charset=UTF-8&");

    /**
     * 存放一些固定的页面，比如200.html,400.html等
     */
    public static Map<HttpStatusCode, HttpResponse> HTML_MAP;
    ...
    public HttpResponse getHttpResponse(HttpStatusCode httpStatusCode) {
        return HTML_MAP.get(httpStatusCode);
    }

    public HttpResponse getHttpResponse(int code) {
        return HTML_MAP.get(HttpStatusCode.getHttpStatusCode(code));
    }
     ...
     */
    public ErrorPageCache() throws Exception {
